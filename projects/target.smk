def get_all_fanconi_cases(wildcards):
    snv = get_fanconi_snv_targets()
    sv = get_fanconi_sv_targets()
    mh = get_fanconi_microhomology_targets()
    hrd = get_fanconi_hrd_score_targets()
...
def get_fanconi_snv_targets():
    return glob_to_df(
        'data/projects/fanconi//patient*/*/snv.vcf',
